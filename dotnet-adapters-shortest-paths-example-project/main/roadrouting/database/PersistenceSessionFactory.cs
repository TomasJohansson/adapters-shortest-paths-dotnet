...
namespace Programmerare.ShortestPaths.Example.Roadrouting.Database {
    ...
    public class PersistenceSessionFactory {
        ...
        /// <summary>
        /// SQLite file at path: ...\dotnet-adapters-shortest-paths-example-project\sqlite_directory\roadrouting.db
        /// </summary>
        ...
        // cd [ the path to the directory ...\dotnet-adapters-shortest-paths-example-project\sqlite_directory ]
        ...
        private static DirectoryInfo TryGetSQLiteSubDirectoryOfProjectRoot(DirectoryInfo directory) {
            ...
            string projectName = System.Reflection.Assembly.GetExecutingAssembly().GetName().Name; // "dotnet-adapters-shortest-paths-example-project"
